...
#SBATCH --time=48:00:00     ##time for the job, two days is maximum
...
#SBATCH --nodes=3            ##any number of nodes
...
export PYTHONPATH=/ceph/hpc/home/eujunsongc/work/Radio_Excess_EDGES/Pop_III/src/VEGA_Python_import_Path_Junsong_Cang:${PYTHONPATH}
